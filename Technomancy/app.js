...
function set_initial_state() {
    ...
    */
    resources = {
        ...
        "hydrogen": { "amount": 0, get value() { if (adventure_data["challenge"] == CHALLENGES.UDM) {
                return 0.01;
        ...
        "void": { "amount": 0, "value": 200000, "mult": 1, "changes": {}, "ps_change": "" },
    };
...
function perm_bag() {
    ...
    let can_deposit = !(event_flags["skills"] != undefined && event_flags["skills"][8]);
    ...
    Object.keys(resources).forEach(function (res) {
        if (resources[res].value > 0 && resources[res].value <= adventure_data["max_bag_value"] && (resources[res].amount > 0 || adventure_data["perm_resources"][res])) { /* We only can store resources with > 0 value. Also only show resources the player knows about. */
            ...
            if (adventure_data["perm_resources"][res] != undefined) { /* This is unlocked for storage*/
                ...
                let deposit_msg = can_deposit ? "<span class='clickable'>Deposit</span> all into bag. " : "";
